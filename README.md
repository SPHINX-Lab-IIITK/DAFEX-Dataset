...
[![DOI](https://zenodo.org/badge/DOI/10.5281/zenodo.22689273.svg)](https://doi.org/10.5281/zenodo.22689273)

**Published dataset:** https://doi.org/10.5281/zenodo.22689273  
**Version:** 1.0.0
...
The DAFEX P80-k3 filtered Android system-call dataset is archived on Zenodo as a versioned research dataset.

**Version-specific DOI:**  
https://doi.org/10.5281/zenodo.22689273

**All-versions DOI:**  
https://doi.org/10.5281/zenodo.22689272

The version-specific DOI identifies the exact **v1.0.0** release described in this repository. The all-versions DOI represents the dataset record across present and future versions.
...
DOI: https://doi.org/10.1016/j.jisa.2026.104437
...
The final DAFEX P80-k3 filtered dataset contains:
...
The `metadata/` directory provides release statistics, filtering decisions, threshold parameters, and integrity information associated with the DAFEX P80-k3 dataset.
...
Contains the filtering metadata for the **671 benign traces removed** by the P80-k3 DAFEX rule.
...
```text
DAFEX-Android-System-Call-Dataset/
|-- README.md
|-- CITATION.bib
|-- CITATION.cff
|-- .gitignore
...
Researchers should clearly report that experiments use the **DAFEX-derived P80-k3 filtered dataset**, rather than referring to it as the original upstream dataset.
...
The **P80-k3** release represents the operating configuration selected in the associated study. Results obtained with this release should not automatically be generalized to other percentile thresholds, voting parameters, datasets, Android environments, malware populations, or system-call collection procedures.
...
The DAFEX-derived metadata, filtering results, documentation, and original release contributions are made available under the **Creative Commons Attribution 4.0 International (CC BY 4.0)** license as specified in the Zenodo record, subject to applicable upstream and third-party rights.

---

## Citation

If you use the **DAFEX P80-k3 filtered dataset**, please cite the dataset:
...
If you use, discuss, reproduce, or compare the **DAFEX filtering methodology**, please also cite the associated publication:
...
For work that uses **both the released dataset and the DAFEX methodology**, citing **both records** is appropriate.
...
When reporting experiments performed using this repository, please identify the data as the **DAFEX-derived P80-k3 filtered Android system-call dataset** to distinguish it from the original upstream corpus.
...
This version corresponds to the initial public research release of the DAFEX **P80-k3** filtered Android system-call dataset.

The archived version is available at:
